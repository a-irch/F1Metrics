...
export default function Home() {
  return (
    <>
      <main className="flex min-h-screen flex-col items-center justify-center px-6 py-24 bg-background text-foreground">
        <div className="max-w-2xl text-center space-y-6">
          ...
          <p className="text-muted-foreground text-lg">
            A minimalist application to browse F1 sessions, drivers, and stats.
            Powered by real-time data from FastF1 project.
          </p>
      ...
      <footer className="absolute bottom-4 text-xs text-muted-foreground items-center justify-center w-full text-center">
